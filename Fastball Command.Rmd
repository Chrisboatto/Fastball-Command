...
```{r}
command_tuned_model <- randomForest(Strike ~ Velocity + HorizontalBreak + VerticalBreak + GamePitchSequence + GameID + Inning + PAofInning, data = command_train, ntree = 60, maxnodes = 250, nodesize = 5, mtry = 2)
```

...
```{r}
command_tuned_model <- randomForest(Strike ~ Velocity + GamePitchSequence + Inning + AtBatPitchSequence + PAofInning + PitchType + YearID, data = command_train, ntree = 100, maxnodes = 8, nodesize = 4)
```

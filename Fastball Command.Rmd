...
```{r}
command_tuned_model <- randomForest(Strike ~ Velocity + HorizontalBreak + VerticalBreak + GamePitchSequence + GameID + Inning + PAofInning, data = command_train, ntree = 100, maxnodes = 50)
```

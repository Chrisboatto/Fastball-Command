...
p <- ggplot(data = command_full, aes(x = PlateLocHeight, y = PlateLocSide)) +
  geom_point()  # Add other layers as needed

# Add geom_rect layer
p + geom_rect(mapping = aes(ymax = 3.6, ymin = 1.6, xmax = -1.2, xmin = 1.2),
              alpha = 0, size = 1, colour = "black") +
  facet_wrap(~Strike)
